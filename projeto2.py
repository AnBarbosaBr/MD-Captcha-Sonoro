...
Conteúdo do Script - o número da linha é aproximado:
    ...
    É um processo bem longo, que demorou várias 
    horas para rodar no meu computador, com um 
    processador AMD A8-7600 (3.10GHz), e 12GB de RAM.
...
## Main functions - usadas para o treino e validação do pipeline escolhido
...
#--------- UTILIZAÇÃO DO MELHOR CLASSIFICADOR --------- ##
...
resultado_teste[[LABEL, ARQUIVO_ORIGINAL, PREDICAO]].to_csv(output_path)
...
resultado_treino[[LABEL, ARQUIVO_ORIGINAL, PREDICAO]].to_csv(output_path)
